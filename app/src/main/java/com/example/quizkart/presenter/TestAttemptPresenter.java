...
import com.example.quizkart.TestAttemptActivity;
import com.example.quizkart.models.QuizAttempted;

import java.util.ArrayList;
import java.util.List;

public class TestAttemptPresenter {

    public static final String KEY_QUIZ_ID = "quiz_identifier";

    private int mPointer = 0;
    private Quiz mSelectedQuiz;

    private TestAttemptActivity mView;
    ...
    public void onSubmitClicked() {
        if (!mIsEvaluated) {
            ...
            int maxMarks = mSelectedQuiz.getmMaxMarks();
            ...
            quizAttempted.setmQuizTitle(mSelectedQuiz.getmTitle());
    ...
    public void start(@Nullable Bundle extras) {
        ...
        if (extras == null || !extras.containsKey(KEY_QUIZ_ID)) {
            mView.showInvalidInput();
            return;
        }

        String quizId = extras.getString(KEY_QUIZ_ID);
    ...
    private void displayQuiz(Quiz currentQuiz) {
        ...
        mQuestions = new ArrayList<>(mSelectedQuiz.getmQuestions().values());
        ...
        mView.loadTitle(mSelectedQuiz.getmTitle());
    }
